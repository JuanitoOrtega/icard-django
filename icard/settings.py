...
# Tabla personalizada para gestionar los usuarios
# https://docs.djangoproject.com/en/4.0/topics/auth/customizing/#using-a-custom-user-model
...
# Para especificar la duración del token de sesión
SIMPLE_JWT = {
